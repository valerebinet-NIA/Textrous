...
def getTable(string, genes):
	...
	res += '<tr style="background-color:#CCCCCC"><th style="text-align:left;border:1px solid black;width:50%">Word</th><th style="text-align:left;border:1px solid black;">Z-Score</th></tr>'
...
def main():
	...
	print '<li id="sec-navli"><a id="sec-navli" href= "#"><b>Table (Z-Scores)</b></a></li>'
