...
def getLink(words, genes):
        return '<a style="text-decoration:none;color:black;" href="https://textrous.irp.nia.nih.gov/clientph.cgi?genes=' + genes + '&words=' + words + '">' + words + '</a>'
...
def main():
	...
	print '<html>'
	print '<head>'
	print '<link rel="stylesheet" type="text/css" href="https://textrous.irp.nia.nih.gov/tw.css"/>'
	print '</head>'
	print '<body>'
	...
	print '<li id="sec-navli"><a id="sec-navli" href="#"><b>Hierarchical Cloud</b></a></li>'
