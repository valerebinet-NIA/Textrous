...
<div style="width:1000px;height:100px;position:absolute;left:0;top:0;overflow:hidden;background-color:#617f10">
	...
	<ul id="main-nav">
		...
		<li id="main-navli" ><a id="main-navli" href="#"><u>About</u></a></li>
...
<div style="width:1000px;position:absolute;left:0px;top:150px;bottom:10px;overflow:auto;background-color:#EEEEEE">
	...
	<h3>About <i>Textrous!</i></h3>
	<hr />
	<p style="text-indent:50px"><i>Textrous!</i> was developed by Hongyu Chen, Bronwen Martin, and Stuart Maudsley at the Intramural Research Program of the National Institute of Aging, National Institutes of Health. Future updates and added functionality is possible. </p>
	</div>
</div>
